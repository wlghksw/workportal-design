    ...
    <div className="saas-layout">
      <aside className="saas-sidebar">
        ...
        <nav className="saas-sidebar__nav">
          ...
          <Link href="/activity" className="saas-nav-item is-active">
            <span className="saas-nav-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <main className="saas-main">
        <header className="saas-topbar">
          <span className="saas-topbar__title">사용 이력</span>
        ...
        <div className="saas-content">
          <Suspense fallback={<div className="activity-loading">목록 로딩 중...</div>}>
            <ActivityList />
          </Suspense>
        </div>
      </main>
