        ...
        <div className="portal-layout__main">
          <Stack spacing="lg">
            <Card variant="default">
              ...
              <Card.Body>
                <Stack spacing="md">
                  <FormField label="URL 목록" htmlFor="urls">
                    <Textarea 
                      id="urls" 
                  ...
                  <FormField label="메인 URL (선택)" htmlFor="featured">
                    <Input id="featured" placeholder="배너용 링크 (비우면 첫 글 자동 적용)" />
                  </FormField>
                  <Cluster className="gap-md">
                    <FormField label="연도" htmlFor="year">
                      <Input id="year" type="number" placeholder="2024" />
                    </FormField>
                    <FormField label="월" htmlFor="month">
                      <Input id="month" type="number" placeholder="12" />
                    </FormField>
                  </Cluster>
                  <Cluster className="cluster-between mt-2">
                    <label className="check-wrap">
                      <input type="checkbox" /> 이전 호 URL 포함
                    </label>
                    <Button variant="primary">뉴스레터 만들기</Button>
                  </Cluster>
                </Stack>
              </Card.Body>
            </Card>
